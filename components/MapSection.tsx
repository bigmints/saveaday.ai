      ...
      <section className="w-full px-6 lg:px-12 pb-24">
        <div className="w-full max-w-[1400px] mx-auto">
          <div className="relative w-full min-h-[560px] md:min-h-0 md:aspect-[21/9] rounded-xl overflow-hidden bg-slate-900 shadow-lg">
            ...
            <div className="relative z-10 h-full min-h-[560px] md:min-h-0 p-7 sm:p-10 lg:p-14 flex flex-col justify-between text-white">
              <div>
              ...
              <div className="grid gap-6 md:grid-cols-2 md:gap-12 items-end">
                <div className="border-l border-white/30 pl-5 sm:pl-7">
                  ...
                  <p className="mt-4 font-serif text-2xl sm:text-3xl leading-snug max-w-lg">
        ...
        <div className="w-full max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {groups.map(({ title, label, description, icon: Icon }) => (
              <article key={title} className="bg-[#EDF8F8] border border-[#3CA6A6]/15 rounded-xl p-8 flex flex-col min-h-[330px] overflow-hidden relative group">
                ...
                <div className="relative z-10 flex h-full flex-col">
                  ...
                  <div className="mt-auto">
                    ...
                    <h3 className="font-serif text-[30px] text-slate-900 mb-3">{title}</h3>
